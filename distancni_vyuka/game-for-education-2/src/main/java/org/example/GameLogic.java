...
public class GameLogic {
    ...
    public void initialize() {
        ...
        Wall wall1 = new Wall(250, 250, 250, 130, Color.BLACK);
        Wall wall2 = new Wall(100, 50, 150, 50, Color.BLACK);
        Wall wall3= new Wall(150, 50, 250, 50, Color.BLACK);
        Wall wall4 = new Wall(250, 50, 400, 50, Color.BLACK);
        Wall wall5 = new Wall(500, 0, 500, 200, Color.BLACK);
        walls.add(wall1);
        walls.add(wall2);
        walls.add(wall3);
        walls.add(wall4);
